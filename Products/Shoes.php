...
<body>
    ...
    <div class="show-product-container">
        <div class="product-container">
            <?php
            $getposts = mysqli_query($conn, "SELECT * FROM products WHERE availableunit >='1' AND item ='shoes'  ORDER BY id DESC LIMIT 10") or die(mysqli_error($conn));
                ...
                while ($row = mysqli_fetch_assoc($getposts)) {
                    ...
                    <div class="product-item">
                        <a href="view_product.php?productid=' . $id . '">
                            <img src="../image/product/shoes/' . $image . '" class="product-image" alt="' . $productname . '">
                        </a>
